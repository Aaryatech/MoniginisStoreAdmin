					...
					<div style="overflow:scroll;height:100%;width:100%;overflow:auto" id="tbl">
								...
								<c:forEach items="${deparmentList}" var="deparmentList" varStatus="count">
											...
											<c:forEach items="${list}" var="list" varStatus="count">
												...
												<td><a href="${pageContext.request.contextPath}/issueMonthSubDeptQtyWieReportByDeptId/${deparmentList.deptId}" class='action_btn'> <abbr title='detailes'> <i class='fa fa-list' ></i></abbr></a>
