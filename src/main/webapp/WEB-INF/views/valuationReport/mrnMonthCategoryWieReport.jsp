				...
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
						 ...
						 <form id="submitPurchaseOrder" action="${pageContext.request.contextPath}/mrnMonthCategoryWieReport" method="get">
								...
								<c:forEach items="${categoryList}" var="categoryList" varStatus="count">
											<tr> 
												...
												<%-- <td ><c:out value="${monthList.approveQty}" /></td> --%> 
														<td style="text-align: right" ><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value="${monthList.approvedQtyValue}" /></td> 
														
														 </c:when>
														</c:choose> 
														</c:forEach> 
												</c:forEach>
												<td style="text-align: right"><a href="${pageContext.request.contextPath}/mrnMonthItemWiseReportBycatId/${categoryList.catId}" class='action_btn'> <abbr title='detailes'> <i class='fa fa-list' ></i></abbr></a>
										    	   ...
										    	   for(var j=0 ; j<data.length ;j++){
										    		   ...
										    		   for(var k=0 ; k<data[j].monthList.length ;k++){
										    			   ...
										    			   if(data1[i].catId==data[j].monthList[k].catId && data[j].monthList[k].monthNo==4){
										    				   ...
										    				   approvedQtyValue=approvedQtyValue+data[j].monthList[k].approvedQtyValue;
										    				   /* arry.push(data[j].monthList[k].approvedQtyValue); */
